...
import static com.example.Music_management.constant.Constant.MUSIC_DLT_TOPIC;
import static com.example.Music_management.constant.Constant.NOTIFICATION_DLT_TOPIC;

/**
 * 死信队列消费者:加歌/通知消息重试耗尽或不可自愈时最终落到这里,
...
public class DeadLetterConsumer {
    ...
    @KafkaListener(topics = {MUSIC_DLT_TOPIC, NOTIFICATION_DLT_TOPIC}, groupId = "my-group")
